...
featuredImage: "../../assets/flutter-marketplace-app-with-stripe-connect-part-2__with_mobile.png"
description:
...
<header>
  In <a href="/flutter-marketplace-app-with-stripe-connect-part-1">Part 1</a> of
  the series, we learnt about how to configure Payments using Stripe Connect for
  the marketplace app <strong>Panda Gums</strong> built with Flutter. And we
  implemented the initial steps of the Seller Onboarding flow. In this article,
  you'll learn how to implement <strong>Deep Links</strong> into the{" "}
  <strong>Panda Gums</strong>
  app. You'll also learn how we'll use <strong>Stripe Checkout</strong> to pay for
  products as customers in the Flutter app. The code repositories for this tutorial
  are as follows:&nbsp;
  <ol>
    <li>
      <a href="https://github.com/ahsanayaz/flutter_stripe_connect">
        Panda Gums (Flutter) App
      </a>
    </li>
    <li>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/deep-link.gif"
  caption="Figure 2.1"
  imageHeight="500"
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/deep-link-register-success.gif"
  caption="Figure 2.2"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/copy-account-id.png"
  caption="Figure 2.3"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/payment-flow.jpg"
  caption="Figure 2.4"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/payment-redirect-to-stripe.gif"
  caption="Figure 2.5"
  imageHeight={500}
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/payment-cancelled.gif"
  caption="Figure 2.6"
  imageHeight={500}
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/payment-successful.gif"
  caption="Figure 2.7"
  imageHeight={500}
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-2/seller-has-balance.png"
  caption="Figure 2.8"
  backgroundColor="transparent"
/>
