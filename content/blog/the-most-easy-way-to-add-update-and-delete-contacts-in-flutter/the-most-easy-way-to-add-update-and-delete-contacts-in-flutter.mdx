...
description:
  In this article, you'll learn the most easy ways to add, update and delete a
...
<IonicCourse />
<header>
  In this article, you'll learn the most easiest ways to implement Adding,
  Updating and Deleting contacts in a Flutter app. And we'll do it using the{" "}
  <a
    href="https://pub.dev/packages/contacts_service"
    target="_blank"
    rel="noopener noreferrer"
  >
    ContactsService
  </a>{" "}
  Flutter package. So hold your horses, and hang tight!
</header>
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/qC90U1rdgHQ"
  frameborder="0"
...
<ImageWithBg
  src="/flutter-contacts-list/update-contact_1.gif"
  imageHeight={400}
/>
...
<ImageWithBg
  src="/flutter-contacts-list/update-contact_2.gif"
  imageHeight={400}
/>
...
<ImageWithBg
  src="/flutter-contacts-list/delete-contact.png"
  imageHeight={400}
/>
...
<ImageWithBg
  src="/flutter-contacts-list/delete-contact_final.gif"
  imageHeight={400}
/>
