...
featuredImage: "../../assets/flutter-marketplace-app-with-stripe-connect-part-1__with_mobile.png"
description:
  In this series of blog posts, you'll learn how to configure Payments using
...
<header>
  In this series of blog posts, you'll learn how to configure Payments using
  Stripe Connect for a marketplace app built with Flutter. I'll also be working
  on a video tutorial series as well. Which will be more detailed and hands-on.
  This article series is for those of you who love reading and following
  articles instead. Find the links below for the code repositories:
...
build the app in and make some test transactions without having to actually pay
anything.

<ImageWithBg
  title="View test data in stripe dashboard"
  alt="View test data in stripe dashboard"
  src="/flutter-marketplace-app-with-stripe-connect-part-1/view-test-data.png"
  caption="Figure 1.1"
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/get-stripe-keys.png"
  caption="Figure 1.2"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/set-branding-info.png"
  caption="Figure 1.3"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/manage-availibility.png"
  caption="Figure 1.4"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/enable-your-country.png"
  caption="Figure 1.5"
  backgroundColor="transparent"
/>
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/enable-card-payments.png"
  caption="Figure 1.6"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/app-start-state.png"
  caption="Figure 1.7"
  imageHeight="500"
  backgroundColor="transparent"
/>
...
In this tutorial, we'll only focus on registering Sellers/Merchants in the app.
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/stripe-connect-onboarding-flow.jpg"
  caption="Figure 1.8"
  backgroundColor="transparent"
/>
...
Now that we understand how the Seller's Registration flow works for our
tutorial, let's jump into the code. We'll begin with creating a Service in our
Flutter application to communicate with the NodeJS backend.
...
folder, hover on `New`, and click on `Package` to create the folder. Inside the
folder, create a file named `stripe-backend-service.dart` and add the following
code:
...
Now install the [url_launcher](https://pub.dev/packages/url_launcher) package in
the flutter app project by running the following command in the project root:
...
the Account Lik URl. Notice that we call the method `canLaunch()` and `launch()`
from the `url_launcher` package using the `response.url` property.
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/no-connected-accounts.png"
  caption="Figure 1.9"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  title="Sellers onboarding flow"
  alt="Sellers onboarding flow image"
  src="/flutter-marketplace-app-with-stripe-connect-part-1/use-test-phone.png"
  caption="Figure 1.10"
  imageHeight="500"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/dummy-form-values.png"
  imageHeight="500"
  caption="Figure 1.11"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/registration-redirect.png"
  imageHeight="500"
  caption="Figure 1.12"
  backgroundColor="transparent"
/>
...
<ImageWithBg
  ...
  src="/flutter-marketplace-app-with-stripe-connect-part-1/seller-account-created.png"
  caption="Figure 1.13"
  backgroundColor="transparent"
/>
